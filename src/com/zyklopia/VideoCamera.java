...
public class VideoCamera extends Activity implements
	SurfaceHolder.Callback, MediaRecorder.OnErrorListener, MediaPlayer.OnErrorListener, OnClickListener, OnLongClickListener {
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		// TODO if (mMediaRecorderRecording) menu.findItem(VIDEO_MENU_ITEM).setVisible(false);
		return result;
	}
    ...
    private boolean initializeVideo() {
		...
		if (isAvailableSprintFFC)
		{
			...
			// TODO VideoCameraNew.unlock(mCamera); ... this is something with front came
